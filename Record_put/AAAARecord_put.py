...
def AAAARecord_put(data, ttl, zone, fqdn, token):
    params = {}
    params['rdata'] = {}
    params['rdata']['address'] = data['rdata']['address']
    params['ttl'] = ttl
	...
	print 'ERROR - Cannot update record:', data['record_type'], '-', data['rdata']['address']
