...
def LOCRecord_get(old_ttl, rec_id, zone, fqdn, token):
	...
	if ((old_ttl > 0) and (old_ttl == result['data']['ttl'])) or (old_ttl <= 0):
	    print fqdn, '-', result['data']['record_type'], '-', result['data']['rdata']['altitude'], result['data']['rdata']['horiz_pre'], result['data']['rdata']['latitude'], result['data']['rdata']['longitude'], result['data']['rdata']['size'], result['data']['rdata']['version'], result['data']['rdata']['vert_pre']
